<nav class="flex flex-col flex-1 px-2 bg-white border-r dark:border-coolgray-200 dark:bg-base" x-data="{
    ...
    <div class="flex pt-6 pb-4 pl-2">
        <div class="flex flex-col w-full">
            <div class="text-2xl font-bold tracking-wide dark:text-white"></div>
		 <img src="https://s3.ap-southeast-2.wasabisys.com/airdrive-coolify/AirDrive-Cloud-Portals.png" alt="AirDrive Logo" class="h-8 w-32 mb-2">
		     {{-- <div class="text-1xl font-bold tracking-wide dark:text-white">Cloud Portal</div> --}}
        ...
        <li class="flex-1 overflow-x-hidden">
            <ul role="list" class="flex flex-col h-full space-y-1.5">
                @if (isSubscribed() || !isCloud())
                    ...
                    <li>
                        <a title="Sponsor us" class="menu-item" href="https://airdrive.cloud"
                            target="_blank">
